      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-neutral-400 hover:text-neutral-500 border  border-neutral-900 hover:dark:border-white/[0.3] py-2 px-4 rounded-full mx-auto " 
            )}
          >
